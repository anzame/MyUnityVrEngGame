...
public class AnsCanCorrect18 : MonoBehaviour
{
    ...
    void MakeNextBoard()
    {
        GameObject OldPrehab = GameObject.Find("QuestionBoard19(Clone)");
        GameObject NextPrehab = (GameObject)Resources.Load("QuestionBoard20");
